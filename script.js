    ...
    class Obstacle{
        ...
        draw(context){
            context.drawImage(
                this.image,
                this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, 
                this.spriteWidth, this.spriteHeight,  // source crop
                this.spriteX, this.spriteY, this.width, this.height  // destination position and size
            );
            if(this.game.debug){
            context.beginPath();
            context.arc(this.collisionX, this.collisionY, this.collisionRadius, 0, Math.PI * 2);
...
class Larva{
    ...
    update(){
        ...
        if(this.collisionY < this.game.topMargin){
            ...
            for (let i = 0; i < 3; i++){
            this.game.particales.push(new Firefly(this.game, this.collisionX, this.collisionY, "yellow"));}
    }
    ...
    this.game.enemies.forEach(enemy => {
        if (this.game.checkCollision(this, enemy)[0]){
            ...
            for (let i = 0; i < 3; i++){
                this.game.particales.push(new Spark(this.game, this.collisionX, this.collisionY, "blue"));}
        }
    })
}
    ...
    class Enemy{
        ...
        draw(context){
            context.drawImage(this.image, this.frameX, this.frameY * this.spriteHeight, 
    ...
    class Game{
        constructor(canvas){
            ...
            canvas.addEventListener("mouseup", e => {
             ...
             window.addEventListener("keydown", e => {
                if (e.key.charCodeAt(0) === 100) { // 100 is ASCII for 'd'
        ...
        render(context, deltaTime){
            if(this.timer > this.interval){
                ...
                this.gameObjects = [this.player, ...this.eggs,
                    ...this.Obstacles, ...this.enemies, ...this.hatchlings, ...this.particales];
            ...
            if(this.score >= this.winningScore){
                ...
                if (this.lostHatchlings <= 5){
                    messege2 = "Nest Defender: Mission Accomplished!";
                    messege1 = "Eggcellent Job!";
                }
                    else {
                        messege2 = "Egg Rescue Attempt: Sunny Side Down.";
                        messege1= "Fallen Guardian";
                    }
                    context.font = "130px Helvetica";
                    context.fillText(messege1, this.width *0.5, this.height *0.5 - 30);
                    context.font = "40px Helvetica";
                    context.fillText(messege2, this.width *0.5, this.height *0.5 + 40);
                    context.fillText("Final  score is "+ this.score +
                    ".  Want to give it another shot? Press 'r' ", 
        ...
        removeGameObjects(){
            ...
            this.particales = this.particales.filter(object => !object.markedForDeletion);
 ...
 this.Obstacles = [];
        ...
        Init(){
            ...
            let attempts= 0;
            while(this.Obstacles.length < this.numberOfObltacles
                && attempts < 500){
